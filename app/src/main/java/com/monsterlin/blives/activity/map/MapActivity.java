package com.monsterlin.blives.activity.map;
...
public class MapActivity extends BaseActivity {
    ...
    private void initData() {
        ...
        markQuery.findObjects(this, new FindListener<MarkPoint>() {
            @Override
    ...
    private void initMap(List<MarkPoint> list) {
        ...
        map.setOnMarkerClickListener(new BaiduMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(final Marker marker) {
                ...
                View popView = LayoutInflater.from(MapActivity.this).inflate(R.layout.view_map_pop, null);
